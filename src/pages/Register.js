...
function Register() {
  ...
  return (
    ...
    //   <h1 classNameName="text-2xl py-4 font-bold">Registration Form</h1>
    //   <form classNameName="w-1/2 mx-auto" onSubmit={onSubmit}>
    ...
    //         classNameName="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
    //         placeholder=" "
    //         required
    //       />
    //       <label
    ...
    //   </form>
    //   <Link to="/login" classNameName="text-blue-700 border-b-2  border-blue-700"> Click Here to Login Page</Link>
    // </div>
